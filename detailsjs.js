...
function getData(dataTitle) {
    return jsonData.filter(
        function(jsonData) {
            return (jsonData.title == dataTitle);
        }
    )
}
...
function DisplayDetails() {
    ...
    var movieTitle = param.get('title');

    movieTitle = movieTitle.replaceAll('_', ' ');

    document.getElementById('mov-title').innerHTML = movieTitle;

    var wholeData = getData(movieTitle);

    document.getElementById('poster-movie').innerHTML = '<img src=' + '\"./data/movie-json-data-master/img/' + wholeData[0].poster + '\" width=\"500em\" height=\"auto\" border=\"10em solid\">';

    var dur = wholeData[0].duration.replace('PT', '');
    dur = dur.replace('M', " Minutes");

    var gen = wholeData[0].genres;
    gen = gen.join(', ');

    document.getElementById('datas-movie').innerHTML = '<h3><b>Year</b> : ' + wholeData[0].year + '</h3><h3><b>Genre</b> : ' + gen + '</h3><h3><b>Duration</b> : ' + dur + '</h3><h3><b>IMDb Rating</b> : ' + wholeData[0].imdbRating + '</h3><h3><b>Description</b> : ' + wholeData[0].storyline + '</h3>';
}
